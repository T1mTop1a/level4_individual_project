...
missing_edges = np.array([[127,330,397,0,0,0],[0,0,0,127,330,397]])
...
preds_val = []
ground_truths_val = []
edge_index_val_pos = torch.ones(pre_neg_sampling_edges_after_graph - 6)
edge_index_val_neg = torch.zeros(pytorch_graph_after.num_edges - pre_neg_sampling_edges_after_graph + 6)

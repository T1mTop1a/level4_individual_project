...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        ...
        self.emb = torch.nn.Embedding(new_data.num_nodes, hidden_channels)
...
edge_label_index = new_val_data["user", "rates", "movie"].edge_label_index
...
with torch.no_grad():
    ...
    ground_truths.append(val_data.edge_index)
